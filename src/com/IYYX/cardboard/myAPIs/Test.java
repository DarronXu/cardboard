...
public class Test {
	public static void main(String[] args) {
	    ...
	    window.getContentPane().add(new MyCanvas(ans[3]));
...
class MyCanvas extends JComponent {
  ...
  public void paint(Graphics g) {
    ...
    Image img1 = Toolkit.getDefaultToolkit().getImage("./res/drawable/boy_pivot_boy_pivot__88a78da_dds.png");
    g2.drawImage(img1, 0, 0, this);
    for(int i=0;i<mModel.fCount;i++)
    {
    	int x1=(int)(512f*mModel.textureUVs.get(i*6+0));
    	int y1=(int)(512f*mModel.textureUVs.get(i*6+1));
    	int x2=(int)(512f*mModel.textureUVs.get(i*6+2));
    	int y2=(int)(512f*mModel.textureUVs.get(i*6+3));
    	int x3=(int)(512f*mModel.textureUVs.get(i*6+4));
    	int y3=(int)(512f*mModel.textureUVs.get(i*6+5));
