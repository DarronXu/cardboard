...
public class CardboardRenderer3 implements CardboardView.StereoRenderer {
	...
	public CardboardRenderer3(Resources res,CardboardOverlayView overlay,Activity context){
		...
		mDad=context;
		vertexShader = res.getString(R.string.vertexShader3);
		fragmentShader = res.getString(R.string.fragmentShader3);
	}
	...
	void render(){
		...
		mUVHandle = GLES20.glGetAttribLocation(mGLProgramHandle, "a_UV");
		int myTextureSamplerHandle = GLES20.glGetUniformLocation(mGLProgramHandle, "myTextureSampler");
	...
	public int loadGLTexture(Bitmap image) {
